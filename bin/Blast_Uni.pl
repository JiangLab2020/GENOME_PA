...
`perl $PUGTA/Tab_Rank.pl GeneLocPS.txt GeneLocPS_Sort.txt 1 3 4`;
`perl $PUGTA/Tab_Rank.pl GeneLocNS.txt GeneLocNS_Sort.txt 1 3 4`;

`perl $PUGTA/LocRegionUni.pl GeneLocPS_Sort.txt $Threshold`;
`perl $PUGTA/LocRegionUni.pl GeneLocNS_Sort.txt $Threshold`;
